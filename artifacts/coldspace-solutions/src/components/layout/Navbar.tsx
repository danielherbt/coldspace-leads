          ...
          <nav className="hidden md:flex items-center space-x-8">
            {navLinks.map((link) => (
              <a
                key={link.href}
                href={link.href}
                className="font-medium transition-colors text-foreground/80 hover:text-secondary"
              >
                {link.label}
              </a>
            ))}
          ...
          <div className="md:hidden absolute top-full left-0 w-full bg-white shadow-xl border-t border-border flex flex-col p-4 animate-in slide-in-from-top-2">
            {navLinks.map((link) => (
              <a
                ...
                className="py-4 px-2 font-semibold border-b border-border text-lg text-foreground/80"
              >
                {link.label}
              </a>
            ))}
            ...
            <a href="tel:+12097615932" className="mt-2 mb-4">
